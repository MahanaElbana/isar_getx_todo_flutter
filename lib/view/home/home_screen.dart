...
import 'package:isar_getx_todo_flutter/widgets/default_show_model_bottom_sheet.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: context.watch<Counter>().count == 1
          ? FloatingActionButton(
              backgroundColor: Colors.pink.shade600,
              // onPressed: () =>  context.read<Counter>().restartCounter(),
              onPressed: () {
                //========== show Model BottomSheet ==========//
                defaultShowModelBottomSheet(context: context );
                //========== show Model BottomSheet ==========//
              },
...
class Count extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: TextStyle(
          color: context.watch<Counter>().selectedColor, fontSize: 24.0),
    );
  }
}
